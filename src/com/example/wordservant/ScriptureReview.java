...
public class ScriptureReview extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        reviewedButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View view) {
				...
				scriptureQuery = myDB.query(getResources().getString(R.string.scripture_table_name), columns_to_retrieve, "scripture_id="+bundledScriptureList.getInt(String.valueOf(currentSelectedPosition)), null, null, null, null);
				...
				updatedValues.put("last_reviewed_date", shortStyle.format(new Date()));
				...
				updatedValues.put("next_review_date", calculatedDate.get(Calendar.MONTH)+1 + "/" + 
						calculatedDate.get(Calendar.DATE) + "/" + calculatedDate.get(Calendar.YEAR));
				
				myDB.update(getResources().getString(R.string.scripture_table_name), updatedValues, "scripture_id = "+bundledScriptureList.getInt(String.valueOf(currentSelectedPosition)), null);
    ...
    protected void displayScriptureContent(int scriptureId) {
        ...
        try{
			...
			scriptureQuery = myDB.query(getResources().getString(R.string.scripture_table_name), columns_to_retrieve, "scripture_id="+scriptureId, null, null, null, null);
			scriptureQuery.moveToFirst();
